...
cd /d "%~dp0"
title Malaak V6.7 - Safe GitHub Upload
...
echo.
echo =====================================================
echo   Malaak V6.7 - Safe One Click GitHub Upload
echo =====================================================
echo.
echo This uploader NEVER creates a new Git history.
echo It clones the latest main branch first, copies V6.7 over it,
...
echo.
echo [2/5] Copying Malaak V6.7 files over the latest GitHub version...
...
echo.
echo [3/5] Preparing the V6.7 commit...
git add -A
if errorlevel 1 goto :git_error

git diff --cached --quiet
if errorlevel 1 (
  git commit -m "Malaak V6.7 - Conversational feminine intelligence training"
  if errorlevel 1 goto :git_error
) else (
...
echo.
echo =====================================================
echo SUCCESS: Malaak V6.7 was uploaded safely to GitHub.
