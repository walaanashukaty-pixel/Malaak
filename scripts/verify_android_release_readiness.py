...
if 'version: 0.6.1+9' not in pubspec:
    fail('pubspec must be Android readiness version 0.6.1+9')
...
for marker in ['Android Release Readiness', '0.6.1+9', 'GitHub Actions', 'Flutter 3.47.1', 'Android Doctor', 'APK', 'AAB']:
    if marker not in readme: fail(f'README missing {marker}')
for marker in ['Malaak Flutter Android V6.1 Source', '0.6.1+9', 'Android Release Readiness', 'Flutter 3.47.1', 'Android Doctor', '68/68']:
